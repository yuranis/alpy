...
class format_alpy_test extends \advanced_testcase {
    ...
    public function test_get_section_name() {
        ...
        $numsections = 5;
        $course = $generator->create_course(array('numsections' => $numsections, 'format' => 'alpy'),
    ...
    public function test_get_default_section_name() {
        ...
        foreach ($coursesections as $section) {
            if ($section->section == 0) {
                $sectionname = get_string('section0name', 'format_alpy');
    ...
    public function test_update_inplace_editable() {
        ...
        $this->setUser($user);
        $course = $this->getDataGenerator()->create_course(array('numsections' => 5, 'format' => 'alpy'),
            array('createsections' => true));
    ...
    public function test_default_course_enddate() {
        ...
        $params = array('format' => 'alpy', 'numsections' => 5, 'startdate' => 1445644800);
    ...
    public function test_get_view_url() {
        ...
        $generator = $this->getDataGenerator();
        $course1 = $generator->create_course(array('format' => 'alpy'));
