...
class format_alpy extends format_base {
     ...
     *
     * In case if course format was changed to 'alpy', we try to copy options
    ...
    public function inplace_editable_render_section_name($section, $linkifneeded = true,
        ...
        if (empty($edithint)) {
            $edithint = new lang_string('editsectionname', 'format_alpy');
        }
        if (empty($editlabel)) {
            $title = get_section_name($section->course, $section);
            $editlabel = new lang_string('newsectionname', 'format_alpy', $title);
        }
    ...
    /**
     * Updates the end date for a course in alpy format if option automaticenddate is set.
     *
